#!/usr/bin/env python3
# Update the TunaOS Flatpak index (tuna-os/docs static index) from a local
# OCI layout. Vendored from tuna-os/finupdate .github/scripts/update-index.py
# so this repo follows the same publish pipeline as other tuna-os flatpaks.
import argparse
import json
...
def main():
    ...
    parser.add_argument("--repo-name", required=True, help="Repository name on GHCR, e.g. tuna-os/blueshell")
